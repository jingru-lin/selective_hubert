...
class HubertPrimarySpeakerDataset(FairseqDataset):
    def __init__(
        self,
        manifest_path: str,
        manifest_noise: str,
    ...
    def _get_single(self, index):
        ...
        return {"id": index, "source": wav, "label_list": labels, "ratio": ratio}
    ...
    def mix_audios(self, aud1, aud2, aud2_db):
        ...
        L = min(np.random.randint(1, 0.5 * len(aud1)), len(aud2))
        # L = min(len(aud1), len(aud2))
